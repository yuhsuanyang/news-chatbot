...
def page():
    ...
    st.number_input(
        "Number of news to read", min_value=10, value=10, step=10, key="num_news"
    )
    ...
    display_messages()
    st.text_input("Message", key="user_input", on_change=process_input, live=False)
